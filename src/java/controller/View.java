...
public class View extends HttpServlet {
    ...
    public void init() throws ServletException {
        String storeName = "Store name is missing.";
        String contactUs = "Email address is missing.";
        ...
        context.setAttribute("storeName", storeName);
        context.setAttribute("contactUs", contactUs);
     }
